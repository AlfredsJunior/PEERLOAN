...
public class SecurityListAdapter extends ArrayAdapter<dbSecurities> {
    private final Context context;
    private List<dbSecurities> myDataset;
    public TextView account, balance,status,loan_amount;
    public ImageView img;

    public SecurityListAdapter(Context context, List<dbSecurities> myDataset) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        dbSecurities securities = myDataset.get(position);
        View rowView =null;
        if (convertView == null) {
            ...
            account.setText("Title: "+securities.getSec_type());
            balance.setText("");
            status.setText("Status: "+securities.getSec_state());
            loan_amount.setText("Date: "+securities.getSec_create_date());
        } else {
