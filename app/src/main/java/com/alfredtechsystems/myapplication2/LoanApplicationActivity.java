...
public class LoanApplicationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new BusinessLoanFragment(), "BUSINESS LOAN");
        adapter.addFragment(new PersonalLoanFragment(), "PERSONAL LOAN");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent myIntent = new Intent(LoanApplicationActivity.this,
                    HomeActivity.class);
