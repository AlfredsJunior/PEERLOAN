...
import com.alfredtechsystems.myapplication2.dataclasses.dbApplications;
import com.alfredtechsystems.myapplication2.dataclasses.dbOperations;
import com.alfredtechsystems.myapplication2.dataclasses.dbUsers;
...
public class LoanEmergencyActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (status.equals("0"))
                {
                    ...
                    RequestQueue queue = Volley.newRequestQueue(LoanEmergencyActivity.this);
                    JsonObjectRequest string_request = new JsonObjectRequest(Request.Method.POST, url_register,register,new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            Intent i = new Intent(LoanEmergencyActivity.this, ViewApplicationsActivity.class);
                            startActivity(i);
                ...
                try
                {
                    ...
                    request.put("tenure","1");
                    request.put("time","");
                    request.put("narration","Emergency Loan");
                    request.put("latitude",latitude);
                    request.put("longitude",longitude);
                    request.put("type","Emergency Loan");
                ...
                JsonObjectRequest string_request = new JsonObjectRequest(Request.Method.POST, url,request,new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(id.equals("0")) {
                            Toast.makeText(LoanEmergencyActivity.this, "Error Submitting", Toast.LENGTH_SHORT).show();
                            insertApplication("PENDING",id);
                        }
                        else{
                            Toast.makeText(LoanEmergencyActivity.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
                            insertApplication(status,id);
                        }
                        Intent i = new Intent(LoanEmergencyActivity.this, ViewLoansActivity.class);
                        startActivity(i);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(LoanEmergencyActivity.this, "Error Connecting", Toast.LENGTH_SHORT).show();
    ...
    public void insertApplication(String status, String status_code) {
        ...
        newApplication.setAppInfo("Emergency Loan");
        newApplication.setAppTenure("1");
        ...
        newApplication.setApplcnType("Emergency");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent myIntent = new Intent(LoanEmergencyActivity.this,
                    HomeActivity.class);
