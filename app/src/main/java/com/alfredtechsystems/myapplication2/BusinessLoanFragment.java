...
public class BusinessLoanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_business_loan, container, false);
        ...
        materialBetterSpinner = (MaterialBetterSpinner) view.findViewById(R.id.android_material_design_spinner);
        collateral_spinner = (MaterialBetterSpinner) view.findViewById(R.id.android_material_collateral_spinner);
        // Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getContext(),R.array.sectors_array, android.R.layout.simple_spinner_item);
    ...
    public void insertApplication(String status, String status_code) {
        ...
        newApplication.setApplcnType("Business");
